<template>
  <div>
    <div class="bg-gradient-to-r from-purple-300 to-blue-200">
      <div class="w-9/12 m-auto py-16 h-full flex items-center justify-center">
...
await menuSable.initHistoryMenus();

const routes = menuSable.historyMenus.value;
if (routes?.length && routes.length < deadline.get(CacheEnum.HISTORY_MENU)?.length) {
